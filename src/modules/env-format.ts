...
export const logger = new Logger(window.createOutputChannel('env-format'))
logger.log('activating extension')

export const formatEditProvider =
	languages.registerDocumentFormattingEditProvider('env', {
...
export const foldingRangeProvider = languages.registerFoldingRangeProvider(
	'env',
	{
